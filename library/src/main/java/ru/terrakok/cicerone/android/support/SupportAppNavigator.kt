...
open class SupportAppNavigator(
  ...
  protected fun fragmentForward(command: Forward) {
    ...
    if (fragmentParams != null) {
      fragmentTransaction.replace(containerId, fragmentParams.fragmentClass, fragmentParams.arguments)
    } else {
   ...
   */
  protected open fun setupFragmentTransaction(command: Command,
